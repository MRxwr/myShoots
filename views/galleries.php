  ...
  function generateGalleryCols($cols,$galleries){
    ...
    foreach( $galleries as $key => $gallery ){
      ...
      if($cols == 1 && in_array($key,$cols1)){ ?>
        <a class="example-image-link" img-id="gm-<?php echo $key; ?>" href="logos/<?= $imageurl ?>" data-lightbox="example-set" data-title="<?php echo $title; ?>">
          <img src="logos/<?= $imageurl ?>" style="width:100%">
        </a>
      <?php
