			...
			<li>
				...
				<li>
					...
					<ul id="ui_book" class="collapse collapse-level-1 two-col-list <?php if($page == 'booking' || $page == 'booking-success' || $page == 'booking-failed'){ ?> in <?php } ?>">
						<li>
							<a href="<?php echo SITEURL; ?>admin/index.php?page=booking" <?php if($page == 'booking'){ ?> class="active" <?php } ?>>Booking All</a>
						</li>
						<li>
							<a href="<?php echo SITEURL; ?>admin/index.php?page=booking-success" <?php if($page == 'booking-success'){ ?> class="active" <?php } ?>><?php echo $lang['booking_success'] ?></a>
						</li>
						<li>
							<a href="<?php echo SITEURL; ?>admin/index.php?page=booking-failed" <?php if($page == 'booking-failed'){ ?> class="active" <?php } ?>><?php echo $lang['booking_faild'] ?></a>
						</li>
						<li>
							<a href="<?php echo SITEURL; ?>admin/index.php?page=booking-cancel" <?php if($page == 'booking-cancel'){ ?> class="active" <?php } ?>><?php echo 'Cancel Bookings' //$lang['booking_faild'] ?></a>
						</li>
					</ul>
				</li>
             ...
             <li>
					...
					<ul id="disabled_date" class="collapse collapse-level-1 two-col-list <?php if($page == 'disabled_date'){ ?> in <?php } ?>">
						<li>
							<a href="<?php echo SITEURL; ?>admin/index.php?page=disabled_date" <?php if($page == 'disabled_date'){ ?> class="active" <?php } ?>>List</a>
						</li>
						<li>
							<a href="<?php echo SITEURL; ?>admin/index.php?page=add_disabled_date">Add New</a>
						</li>
					</ul>
				</li>
				<li><hr class="light-grey-hr mb-10"/></li>
				...
				<li>
					...
					<ul id="pages_cdr" class="collapse collapse-level-1 two-col-list <?php if($page == 'booking-calendar'){ ?> in <?php } ?>">
						<li>
							<a href="<?php echo SITEURL; ?>admin/index.php?page=booking-calendar" <?php if($page == 'booking-calendar'){ ?> class="active" <?php } ?>>Booking Calendar</a>
						</li>
						<li>
							<a href="<?php echo SITEURL; ?>admin/index.php?page=enable_date" <?php if($page == 'enable_date'){ ?> class="active" <?php } ?>>Open/Close date</a>
						</li>
