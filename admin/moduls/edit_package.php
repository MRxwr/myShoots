									...
									<div class="panel-body">
										<div class="form-wrap">
                                            ...
                                            <div   ng-app="shanidkvApp">
                                                ...
                                                <input class="btn-primary btn-sm" type="submit" name="submit" id="submit"  value="<?php echo $lang['edit_package'] ?>">
                                                </div>
