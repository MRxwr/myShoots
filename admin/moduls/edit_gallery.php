		...
		if (isset($_GET['id']) && !empty($_GET['id'])) {
			...
			if($res==true)
			{
				...
				if($count_rows==1)
				{
					...
					$image_path = "../uploads/images/".$row['image_url'];
					$image = $row['image_url'];
									...
									<div class="panel-body">
										<div class="form-wrap">
                                            ...
                                            <div class="form-group">
                                                ...
                                                $res = $obj->execute_query($conn,$query);
												while ($row1=$obj->fetch_data($res)) {
												 $categoriesid = $row1['id'];
						                         $title = $row1['title_'.$_SESSION['lang']];
												?>
                                                ...
                                                <div class="form-group">
													...
													<input type="file" id="input-file-max-fs" name="image_url" class="dropify"  data-default-file="<?php echo $image_path; ?>"/>
