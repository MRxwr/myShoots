													...
													if($count_rows > 0)
													{
														while ($row=$obj->fetch_data($res)) {
															...
															<tr>
															   ...
															   <td >
																<p style="margin-bottom: 10px;">	<?php if($is_active=='Yes'){echo $lang['yes'];}else if($is_active=='No'){echo $lang['no'];} ?></p>
															<a  class="btn btn-primary d-inline  btn-xs bookingcancel" onclick="bookingCancel(<?=$id?>)"  id="<?=$id?>" style="margin-bottom: 10px;" ><?=$lang['cancel']?></a>
															
															<a  class="btn btn-primary <?=($sms==1?'btn-success':'btn-primary')?>  btn-xs bookingsms" onclick="sendSms(<?=$id?>)"  id="<?=$id?>" style="margin-bottom: 10px;"><?php if($sms==1){echo $lang['sent'];}else{echo $lang['sms'];} ?></a>
																</td>
															</tr>
														<?php
													  }
