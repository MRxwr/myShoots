    	...
    	<!-- Title -->
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h5 class="txt-dark"><?php echo $lang['categories'] ?></h5>
					</div>
					...
					while ($row=$obj->fetch_data($res)) {
						...
						<tr>
							...
							<td>
								...
								<a href="<?php echo SITEURL; ?>admin/moduls/delete.php?page=categories&id=<?php echo $id; ?>" class="btn-error btn-sm"><?php echo $lang['delete'] ?></a>
							</td>
						</tr>
