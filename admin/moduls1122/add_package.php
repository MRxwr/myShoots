										...
										<div class="form-wrap">
											<form method="post" action=""  enctype='multipart/form-data'>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div ng-app="angularjs-starter" ng-controller="MainCtrl">
                                                         <div class="row" data-ng-repeat="choice in choices">
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <label class="control-label mb-10 text-left"><?php echo $lang['extra_items'] ?></label>
                                                                    <input type="text" name="price" class="form-control"  ng-model="choice.item" >
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                               ...
                                               <div class="form-group">
												...
												<div class="form-group">
                                                <input class="btn-primary btn-sm" type="submit" name="submit" value="<?php echo $lang['add_package'] ?>">
                                                </div>
